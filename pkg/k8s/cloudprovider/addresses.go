...
const (
	ExternalIPAnnotation = "vcluster.loft.sh/node-ip-external"
)
...
func populateInternalAddress(addrs *[]v1.NodeAddress, node *v1.Node) {
	...
	// Finally, if no vcluster or node-ip adornments on the node have been found, rely on the IP addresses that
