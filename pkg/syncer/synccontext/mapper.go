...
type MappingsStore interface {
	// Start starts the mapping store
	Start(ctx context.Context) error

	// RecordReference records a reference mapping
	RecordReference(ctx context.Context, nameMapping NameMapping) error

	// RecordLabel records a label mapping in the store
	RecordLabel(ctx context.Context, labelMapping LabelMapping) error

	// RecordLabelCluster records a label mapping for a cluster scoped object in the store
	RecordLabelCluster(ctx context.Context, labelMapping LabelMapping) error
